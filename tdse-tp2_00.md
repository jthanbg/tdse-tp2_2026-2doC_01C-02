...
https://gemini.google.com/app/3cdc8c0b4cff48a3
...
Tabla de Transiciones (Matriz): Creas una matriz bidimensional (Array) donde las filas son los estados, las columnas los eventos, y el contenido de la celda es el "Siguiente Estado". Es muy rápido y consume pocos recursos de CPU, pero gasta más memoria RAM.
Punteros a Funciones: Cada estado es una función independiente en C (void estado_bloqueado(), void estado_desbloqueado()). Una variable puntero de función apunta al estado actual y se va reasignando. Es el método más limpio y escalable utilizado en ingeniería de software profesional.
